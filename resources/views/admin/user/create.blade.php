    ...
    <div class="max-w-xl mx-auto space-y-6">
        <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">Isi data di bawah ini untuk membuat akun pengguna baru.</p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            <form action="{{ url('/admin/user/store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="tel" name="telp" value="{{ old('telp') }}" placeholder="08xxxxxxx" maxlength="12"
